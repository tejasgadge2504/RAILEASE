            ...
            ElevatedButton(
              onPressed: () {
                ...
                if (Name.text.isEmpty ||
                    ...
                    Email_ID.text.isEmpty ||
                    VES_ID.text.isEmpty ||
                    Admission_Year.text.isEmpty ||
                    Expected_Graduation_Year.text.isEmpty ||
                    Branch.text.isEmpty ||
                ...
                String PriKey = RollNo.text + "_" + Division.text;
                ...
                databaseRef.child(PriKey).set({
                  ...
                  'Division': Division.text.toString().toUpperCase(),
